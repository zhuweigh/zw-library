...
from .forms import setPasswordForm, registrationForm, loginForm, addBookForm, addImageForm,BookEditForm,ImageEditForm
...
def edit(request,id):
	...
	if request.method == 'POST':
		...
		book_form=BookEditForm(instance=book)
	return render(request, 'management/edit.html', {'book_form':book_form})
